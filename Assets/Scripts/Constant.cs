...
{
    public const float MIN_INPUT_DISTANCE = 0.005f;
    public const float MIN_DISTANCE_TO_TARGET = 0.5f;
    public const float DEFAULT_SPEED = 10f;
    public const float HERO_SPEED = 12f;
    public const float RANDOM_MOVE_TIMER_COOLDOWN = 1f;
    public const float REDUCE_SCALE_DEFAULT_STEP = 0.5f;
